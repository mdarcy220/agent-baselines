...
def load_tasks_from_config(
    ...
    all_tasks = []
    for split_obj in suite_config.splits:
        tasks_in_split = suite_config.get_tasks(split_obj.name)
    ...
    # Otherwise return all tasks from the specified split (function parameter)
